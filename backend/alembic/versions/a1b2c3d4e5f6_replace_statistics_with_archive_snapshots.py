...
down_revision: str | None = "6af81fd1122b"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["archive_id"], ["xml_archives.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )

    # Create indexes for efficient queries
    op.create_index(op.f("ix_archive_snapshots_id"), "archive_snapshots", ["id"], unique=False)
    op.create_index("idx_snapshot_archive_id", "archive_snapshots", ["archive_id"], unique=False)
    op.create_index("idx_snapshot_recorded_at", "archive_snapshots", ["recorded_at"], unique=False)
    op.create_index(
