...
def upgrade() -> None:
    ...
    op.add_column("archive_snapshots", sa.Column("http_etag", sa.String(), nullable=True))
    op.add_column("archive_snapshots", sa.Column("http_last_modified", sa.String(), nullable=True))
