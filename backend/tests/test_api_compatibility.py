...
from app.models.statistics import MetricType, StatisticModel
...
class TestBiologicalUnitsProvidersEndpoint:
    ...
    def test_providers_exclude_failed_archives(self, mock_get_db):
        ...
        stat_failed.extra_data = {"archive_id": 102, "processing_failed": True, "failure_count": 3}
...
class TestBiologicalUnitsTimelineEndpoint:
    ...
    def test_timeline_endpoint_response_format(self, mock_get_db):
        ...
        expected_format = {
            "timeline": [
                {"date": "2024-01-15", "biological_units": 1000, "provider_id": 1},
                {"date": "2024-03-10", "biological_units": 1500, "provider_id": 1},
                {"date": "2024-06-20", "biological_units": 2000, "provider_id": 1},
            ],
    ...
    def test_timeline_returns_correct_historical_data(self, mock_get_db):
        ...
        stat2.target_date = date(2024, 3, 10)
        stat2.value = 1500
        stat2.extra_data = {"archive_id": 102, "first_processed_at": "2024-03-10T14:00:00"}
...
class TestStatisticsSummaryEndpoint:
    ...
    def test_summary_endpoint_response_format(self, mock_get_db):
        ...
        expected_format = {
            ...
            "by_period": {
                "daily": {"datasets": 5, "biological_units": 2000},
                "weekly": {"datasets": 30, "biological_units": 15000},
                "monthly": {"datasets": 150, "biological_units": 50000},
            },
    ...
    def test_summary_excludes_failed_archives(self, mock_get_db):
        ...
        for i in range(10):
            ...
            if i < 7:  # 7 successful
                ...
                stat.value = 0
                stat.extra_data = {"archive_id": i, "processing_failed": True, "failure_count": 2}
