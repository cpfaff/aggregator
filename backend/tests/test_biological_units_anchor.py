...
class TestAnalyzeXmlArchivesAnchorLogic:
    ...
    def test_analyze_uses_dataset_created_at_for_first_processing(self, mock_parse, mock_session, mock_archive):
        ...
        with patch('app.tasks.statistics_tasks.is_archive_first_processing', return_value=True):
            with patch('app.tasks.statistics_tasks.get_archive_anchor_date', return_value=date(2024, 1, 1)) as mock_get_anchor:
    ...
    @patch('app.tasks.statistics_tasks.SessionLocal')
    @patch('app.tasks.statistics_tasks.parse_abcd_xml')
    def test_analyze_uses_current_date_for_subsequent_processing(self, mock_parse, mock_session, mock_archive):
        ...
        with patch('app.tasks.statistics_tasks.is_archive_first_processing', return_value=False):
            with patch('app.tasks.statistics_tasks.get_archive_anchor_date', return_value=date(2024, 6, 15)) as mock_get_anchor:
    ...
    @patch('app.tasks.statistics_tasks.SessionLocal')
    @patch('app.tasks.statistics_tasks.parse_abcd_xml')
    def test_analyze_handles_failure_and_marks_archive(self, mock_parse, mock_session, mock_archive):
    ...
    @patch('app.tasks.statistics_tasks.SessionLocal')
    @patch('app.tasks.statistics_tasks.parse_abcd_xml')
    def test_analyze_skips_archives_exceeding_max_retries(self, mock_parse, mock_session, mock_archive):
...
class TestTimelineIntegration:
    ...
    def test_biological_units_timeline_with_historical_anchors(self, mock_parse, mock_session):
        ...
        with patch('app.tasks.statistics_tasks.is_archive_first_processing', return_value=True):
            with patch('backend.app.tasks.statistics_tasks.get_archive_anchor_date') as mock_get_anchor:
