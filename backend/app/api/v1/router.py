...
api_v1_router.include_router(statistics_router, prefix="/statistics", tags=["statistics"])
api_v1_router.include_router(public_statistics_router, prefix="/public-statistics", tags=["public-statistics"])
